...
| [`Ex003_JogoAdivinhacao`](./src/Ex003_JogoAdivinhacao)     | Jogo de adivinhação de números aleatórios com até 5 tentativas                           | `Random`, `Scanner`, `for`, `while`, `break`        |
| [`Ex004_MathHub`](./src/Ex004_MathHub)                     | Central de utilitários: tabuada, comparação de inteiros, fatorial e cálculo de áreas     | `Scanner`, `switch`, `for`, `if/else`               |
| [`Ex005_JavaCash`](./src/Ex005_JavaCash)                   | Simulador de conta bancária com consulta, depósitos e transferências                     | `Scanner`, `Random`, `while`, `switch`, `if/else`   |
