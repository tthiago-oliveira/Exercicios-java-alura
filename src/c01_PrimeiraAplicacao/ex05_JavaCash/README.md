...
- **Consulta de Saldo:** Exibição do valor atualizado em conta.
- **Recebimento de Valores:** Depósito e atualização imediata do saldo.
- **Transferência:** Validação de saldo disponível antes de efetuar o débito.
- **Menu Interativo:** Navegação contínua via laço `while` e `switch-case`.